      ...
      <main>
        <section className='bg-[var(--bg-alt)] py-10 lg:py-14'>
          <div className='container mx-auto space-y-8 px-4'>
            ...
            <div className='mx-auto max-w-[720px] rounded-2xl border border-[var(--border)] bg-white p-4'>
              <input value={q} onChange={(e) => setQ(e.target.value)} className='h-11 w-full rounded-full border border-[var(--border)] bg-white px-4' aria-label='Search stores' placeholder='Search by store name, city, or country' />
            </div>
            {filtered.length === 0 ? (

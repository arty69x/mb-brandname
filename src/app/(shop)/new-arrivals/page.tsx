...
export default function NewArrivalsPage() {
  ...
  useEffect(() => {
    async function loadProducts() {
      const data = await api.getProducts({ newArrival: true });
      setProducts(data);
    }
  ...
  return (
    <main className="bg-[#f2f2f2] min-h-screen">
      <section className="relative h-[360px] md:h-[420px] overflow-hidden">
        <Image
          src="https://images.pexels.com/photos/5625132/pexels-photo-5625132.jpeg?auto=compress&cs=tinysrgb&w=2000"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white text-5xl md:text-7xl uppercase font-light tracking-[0.14em]">New Arrivals</h1>
        </div>
      </section>

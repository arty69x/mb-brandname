...
export default function Footer() {
  return (
    <footer className='bg-[#020202] pt-16 text-[#f5f5f5]'>
      <div className='container mx-auto grid grid-cols-1 gap-10 px-4 pb-14 lg:grid-cols-5'>
        <div>
          ...
          <p className='text-[14px] leading-7 text-[#c6c6c6]'>1418 River Drive, Suite 35 Cottonhall, CA 9622</p>
          <p className='text-[14px] leading-7 text-[#c6c6c6]'>United States</p>
          <p className='mt-4 text-[14px] leading-7 text-[#c6c6c6]'>sale@uomo.com</p>
          <p className='text-[14px] leading-7 text-[#c6c6c6]'>+1 246-345-0695</p>
        </div>

        <div>
          <p className='mb-6 text-[16px] uppercase'>Company</p>
          <div className='space-y-3 text-[14px] text-[#c6c6c6]'>
            {company.map((item) => (
              <p key={item}>{item}</p>
            ))}
          </div>
      ...
      <div className='border-t border-white/10 py-5 text-center text-[12px] text-[#c6c6c6]'>
        <span>©2020 Uomo</span>

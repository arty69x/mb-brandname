...
const classes: Record<Variant, string> = {
  ...
  secondary:
    'inline-flex items-center justify-center rounded-full border border-[#d9d9d9] bg-white px-6 py-3 text-[12px] uppercase tracking-[0.12em] text-[#1a1a1a] transition-colors duration-300 ease-in-out hover:bg-[#f3f3f3] focus:outline-none focus:ring-2 focus:ring-[var(--accentGold)] focus:ring-offset-2',
  pill:

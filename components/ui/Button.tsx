...
const classes: Record<Variant, string> = {
  ...
  pill:
    'inline-flex items-center justify-center rounded-full border border-[var(--border)] bg-white px-5 py-2 text-[12px] uppercase tracking-[0.12em] text-[var(--text)] transition-colors duration-300 ease-in-out hover:bg-[var(--bg-alt)] focus:outline-none focus:ring-2 focus:ring-[var(--accentGold)] focus:ring-offset-2'
};
